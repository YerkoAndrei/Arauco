...
public class Protagonista_tutorial_comp : MonoBehaviour {

	public static float vida;
	public static float vida_max = 250f;
	public static float vel_cura = 10f;	// Velocidad de regeneracion
	...
	void OnTriggerEnter(Collider col)
	{
		...
		{
			if (col.tag == "Arma valdivia") {		// Daño por valdivia
				if (col.gameObject.transform.parent.parent.parent.parent.parent.parent.parent.parent.parent.parent.parent.parent.GetComponent<Valdivia_tutorial_comp> ().ataque_valdivia) {
					...
					tiempo_reg = 3f;
					col.gameObject.transform.parent.parent.parent.parent.parent.parent.parent.parent.parent.parent.parent.parent.GetComponent<Valdivia_tutorial_comp> ().ataque_valdivia = false;
				}
